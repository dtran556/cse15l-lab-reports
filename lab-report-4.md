...
To log into my ieng6 account I typed ```ssh cs15lwi23aun@ieng6.ucsd.edu <enter> ```which automatically logged me into the remote server because I added my github ssh key to my account:
